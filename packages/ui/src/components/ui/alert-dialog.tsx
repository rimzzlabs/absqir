...
function AlertDialog({ actionsRef, ...props }: AlertDialogPrimitive.Root.Props) {
  ...
  return (
    <PopupActionsProvider actionsRef={actions}>
      <AlertDialogPrimitive.Root data-slot="alert-dialog" actionsRef={actions} {...props} />
    </PopupActionsProvider>
  );
}
...
/**
 * The scrolling middle of a tall alert dialog. See `DialogBody`. An alert with
 * a long list to confirm needs it; a two-line warning does not.
 */
