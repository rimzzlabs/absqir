...
export const my = {
  events: {
    ...
    emptyUpcoming: "Belum ada yang menunggu Anda",
  ...
  event: {
    ...
    notExpected: "Acara yang tidak mengharapkan Anda tidak muncul di sini.",
    timeline: "Lini masa",
    ...
    you: "Anda",
    nothingYet: "Belum ada apa pun di daftar hadir.",
    ...
    waiting: "Menunggu",
    noRecord: "Tidak ada catatan untuk Anda.",
  ...
  leave: {
    ...
    waitingEmpty:
      "Tidak ada yang menunggu. Tidak bisa hadir? Ajukan sebelum acaranya mulai, dengan alasan.",
