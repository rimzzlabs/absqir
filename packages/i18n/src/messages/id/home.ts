...
export const home = {
  ...
  accounts_one: "{{count}} akun",
  accounts_other: "{{count}} akun",
  invitationsWaiting_one: "Satu undangan masih menunggu diterima.",
  invitationsWaiting_other: "{{count}} undangan masih menunggu diterima.",
  reviewInvitations: "Periksa undangannya",
  stats: {
    events: "Acara",
    eventsHint: "{{count}} sudah ditutup",
  ...
  gettingStarted: {
    ...
    title: "Langkah awal",
    step: "Langkah {{done}} dari {{total}}",
    progressLabel: "{{done}} dari {{total}} langkah selesai",
