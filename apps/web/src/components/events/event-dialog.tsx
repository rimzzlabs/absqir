          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4" noValidate>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <FormField
                ...
                label="Starts"
                render={(field) => (
                  <DateTimePicker id="event-starts" value={field.value} onChange={field.onChange} />
                )}
              />
              <FormField
                control={form.control}
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="event-walk-ins">Let members outside these groups check in too</Label>
            </div>
